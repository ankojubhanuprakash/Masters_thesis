...
function storedata(){
            ...
            //url2 = 'https://iitkiqtest.azurewebsites.net/az_master_write_data.php?csv_file=server.csv&dir=msths&email=true&method=3&flds='+'name,email,gender,rvn_score,std_rvn_score,test_duration'
            url2 = 'https://srivalab-compute.cse.iitk.ac.in/bhanu/write_data.php?csv_file=server.csv&dir=msths&email=true&method=3&flds='+'name,email,gender,rvn_score,std_rvn_score,test_duration'
